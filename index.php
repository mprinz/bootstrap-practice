				...
				<div class="row">
					...
					<div id="carousel" class="carousel slide" data-ride="carousel">
						...
						<ol class="carousel-indicators">
							...
							<li datat-target="#carousel" data-slide-to="2"></li>
						</ol>

						<!-- Wrapper for slides -->
						<div class="carousel-inner" role="listbox">
							<div class="item active">
								<img src="images/IMG_1431.JPG" alt="photo">
								</div>
							<div class="item">
								<img src="images/Sculpture.JPG" alt="photo1">
								</div>
							</div>
							<div class ="item">
								<img src="images/La%20Cienaga%20Petroglyph.JPG" alt="photo2">
					</div>
